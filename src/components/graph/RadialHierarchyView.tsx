...
export const RadialHierarchyView = ({
  ...
  }, [data?.edges, nodes, expandedDispositivosMap, artigoPositions, lei14133ActId, decreto68304ActId, decreto68422ActId, decreto68220ActId, decreto69233ActId, decreto67689ActId]);
  ...
  const highlightedArticlesMap = useMemo(() => {
    ...
    return map;
  }, [showRegulamentaLinks, articleLinks, nodes, decreto68304ActId, decreto68422ActId, decreto68220ActId, decreto69233ActId, decreto67689ActId, lei14133ActId]);
